...
<style>
  label ,input[type=text],input[type=email],input[type=password],input[type=number],input[type=submit] {
      font-size:1.63em;
}
  </style>
</head>
  ...
  <div class="row">
    ...
    <form method="post" class="form-horizontal col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="number" name="phone"  class="form-control" id="input1" placeholder="your phone number"required />
          </div>
      </div>
