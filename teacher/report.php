...
<br>
        <div class="form-group">
           <label for="input1" class="col-sm-3 control-label">Student Reg. No.</label>
              <div class="col-sm-7">
                <br>
                  <input type="text" name="sr_id"  class="form-control" id="input1" placeholder="enter student reg. no." />
              </div>
        </div>
        <br>
